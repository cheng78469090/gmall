...
public class PmsOssController {
    String accessId = "LTAI4Fh8nPHBNEck9M1MCYGR"; // 请填写您的AccessKeyId。
    String accessKey = "LEEdSlASICrpWFhWsQPkvmFa7iP02J"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "sjc-gmall"; // 请填写您的 bucketname 。
